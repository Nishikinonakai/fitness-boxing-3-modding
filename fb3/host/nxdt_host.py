...
def usbGetDeviceEndpoints() -> bool:
    ...
    while True:
        ...
        # Reset device. (Skipped on macOS: reset() re-enumerates the device and
        # invalidates the handle, making the following set_configuration() fail with
        ...
        try:
            ...
            # On macOS the device may already be configured by the OS; ignore and continue.
            pass
